...
function Measures({data}) {
    return(
        <div id="measures" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white">
                <div
                    className="max-w-screen-xl mx-auto pt-12 pb-16 sm:pt-16 ">
                        ...
                        <dl className="md:grid md:grid-cols-2 md:gap-8">
                            ...
                            <div className="mt-12 md:mt-0">
                                <div>
                                    ...
                                    <dd className="mt-2">
                                        <p className="text-base leading-6 text-gray-500">
                                            Sign language. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas
                                            cupiditate laboriosam fugiat.
                                        </p>
                                    </dd>
                                </div>
            ...
            <div className="bg-white">
            <div className="max-w-screen-xl mx-auto pt-12 pb-16 sm:pt-16 ">
            <h2 className="text-3xl leading-9 font-extrabold text-gray-900">Medidas tomadas por bancos y cooperativas </h2>
            <div className="mt-6 border-t-2 border-gray-100 pt-10">
                <dl className="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        <div>
